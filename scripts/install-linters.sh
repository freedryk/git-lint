...
sudo apt-get install curl build-essential php-pear optipng pngcrush php5 checkstyle libjpeg-turbo-progs xsltproc cmake gfortran libreadline6 libreadline6-dev xorg-dev zlib1g-dev
